...
def visualise_model(plotter, model_directory, left_original_landmark_file, right_original_landmark_file,
    ...
    left_differences = calculate_differences(left_original_landmarks, left_predicted_landmarks)
    right_differences = calculate_differences(right_original_landmarks, right_predicted_landmarks)

    visualise_meshes(plotter, mesh_files)
    visualise_landmarks(plotter, left_predicted_landmarks, left_differences, 'left', 'red')
    visualise_landmarks(plotter, right_predicted_landmarks, right_differences, 'right', 'red')
